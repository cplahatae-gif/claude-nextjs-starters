...
description: UI 컴포넌트의 정적 마크업과 스타일링을 담당합니다. Tailwind CSS + Shadcn UI 기반 레이아웃, 반응형 디자인 작업에 사용하세요.
model: sonnet
color: red
---
...
- 랜딩 페이지, 카드 레이아웃 등 UI 마크업 생성
- 기존 컴포넌트의 스타일 개선 및 리디자인
- 반응형 네비게이션, 모바일 메뉴 등 레이아웃 구현
